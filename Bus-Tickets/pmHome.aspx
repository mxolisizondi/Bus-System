<%@ Page Title="" Language="C#" MasterPageFile="~/passMaster.Master" AutoEventWireup="true" CodeBehind="pmHome.aspx.cs" Inherits="Bus_Tickets.WebForm1" %>
    ...
    <div class="carousel slide" data-ride="carousel" id="slides">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="img/cus3.jpg" width="1400" height="500">
                <div class="carousel-caption">
                    <h3>Passegers</h3>
                    <p>We aim to ensure that our passeger or customer recieve the best services</p>
                    ...
                    <p id="moreInfo" class="collapse">
                        ...
                        bicycles, buses, trains, trucks, helicopters, watercraft, spacecraft and aircraft.
            ...
            <div class="carousel-item">
                <img src="img/cus1.jpg" width="1400" height="500">
                <div class="carousel-caption">
                   <h3>Passegers</h3>
                    <p>We aim to ensure that our passeger or customer recieve the best services</p>
            ...
            <div class="carousel-item">
                <img src="img/cus2.jpg" width="1400" height="500">
                <div class="carousel-caption">
                    <h3>Passegers</h3>
                    <p>We aim to ensure that our passeger or customer recieve the best services</p>
