<%@ Page Title="" Language="C#" MasterPageFile="~/managerMaster.Master" AutoEventWireup="true" CodeBehind="mngProfile.aspx.cs" Inherits="Bus_Tickets.WebForm15" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col col-lg-10 col-md-10 col-sm-10 col-xs-10">
            ...
            <br />
            <asp:Button ID="btnUpdate" CssClass="btn btn-md btn-outline-info" runat="server" Text="Update Details" OnClick="btnUpdate_Click" />
            <br />
            <br />
        </div>
    </div>
