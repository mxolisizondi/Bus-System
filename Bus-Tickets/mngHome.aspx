<%@ Page Title="" Language="C#" MasterPageFile="~/managerMaster.Master" AutoEventWireup="true" CodeBehind="mngHome.aspx.cs" Inherits="Bus_Tickets.WebForm14" %>
        ...
        <div class="carousel slide" data-ride="carousel" id="slides">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/mng3.jpg" width="1400" height="600">
                    <div class="carousel-caption">
                    <h3>Managers</h3>
                    <p>We aim to ensure that our lead and control all the staff to ensure quality of services</p>
                ...
                <div class="carousel-item">
                    <img src="img/mng2.jpg" width="1400" height="600">
                    <div class="carousel-caption">
                    <h3>Managers</h3>
                    <p>We aim to ensure that our lead and control all the staff to ensure quality of services</p>
                ...
                <div class="carousel-item">
                    <img src="img/mng1.jpg" width="1400" height="600">
                    <div class="carousel-caption">
                    <h3>Managers</h3>
                    <p>We aim to ensure that our lead and control all the staff to ensure quality of services</p>
