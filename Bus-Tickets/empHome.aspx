<%@ Page Title="" Language="C#" MasterPageFile="~/empMaster.Master" AutoEventWireup="true" CodeBehind="empHome.aspx.cs" Inherits="Bus_Tickets.WebForm10" %>
        ...
        <div class="carousel slide" data-ride="carousel" id="slides">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/cty2.jpg" width="1400" height="600">
                    <div class="carousel-caption">
                    <h3>Drivers(Employee)</h3>
                    <p>We aim to ensure that our passeger or customer recieve the best services and comfortable trip ever!!</p>
                    ...
                    <p id="moreInfo" class="collapse">
                        ...
                        and cope with a position that can in some ways be monotonous. They must transport passengers to and
                        from destinations on a predefined route. A driver must also obviously be a careful and skilled driver 
                        who is able to traverse heavy traffic and make sure the passengers arrive safely 
                    </p>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="img/drv1.jpg" width="1400" height="600">
                    <div class="carousel-caption">
                    <h3>Drivers(Employee)</h3>
                    <p>We aim to ensure that our passeger or customer recieve the best services and comfortable trip ever!!</p>
                ...
                <div class="carousel-item">
                    <img src="img/rd4.jpg" width="1400" height="600">
                    <div class="carousel-caption">
                    <h3>Drivers(Employee)</h3>
                    <p>We aim to ensure that our passeger or customer recieve the best services and comfortable trip ever!!</p>
