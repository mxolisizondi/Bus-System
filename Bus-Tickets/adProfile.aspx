<%@ Page Title="" Language="C#" MasterPageFile="~/adminMaster.Master" AutoEventWireup="true" CodeBehind="adProfile.aspx.cs" Inherits="Bus_Tickets.WebForm8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col col-lg-10 col-md-10 col-sm-10 col-xs-10">
            ...
            <br />
            <asp:Button ID="btnUpdate" CssClass="btn btn-md btn-outline-info" runat="server" Text="Update Admin Details" OnClick="btnUpdate_Click" />
            <br />
            <br />  
        </div>
    </div>
